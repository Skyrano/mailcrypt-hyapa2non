...
import { expand } from '../utils/helpers.js';
...
var PBES1Algorithm = Algorithm(PBEParameter, {
    ...
    decode: function(value) {
        var algorithm = expand(algorithms[value.algorithm]);
        algorithm.derivation = expand(algorithm.derivation, { salt: value.parameters.salt, iterations: value.parameters.iterationCount });
        return algorithm;
    }
});
