...
import { GostRandom } from '../gostRandom.js';
...
import { gostCMSInstance } from './gostCMS.js';
import { gostKeysInstance } from './gostKeys.js';
 ...
 *
 * First try to uytes based on standart Math.random mixed with time and mouse pointer
 *
 * @memberOf gostCrypto
